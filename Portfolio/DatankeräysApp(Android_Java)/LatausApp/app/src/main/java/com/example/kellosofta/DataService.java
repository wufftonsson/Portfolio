...
// Kun tausta-ajo luodaan
    ...
    @Override // Ensin tallennetaan sensorin tyyppi sensortype muuttujaan, Listeneri tallentaa sensori dataa sensorEvent.values taulukkoon, sieltä indexissä nolla on sydämen syke arvo.
